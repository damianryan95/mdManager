...
This guidance is intended for use with Claude Desktop, Claude Code, Codex, GitHub Copilot agents, or any AI-assisted development workflow.
...
## 11. Claude Desktop / MCP Guidance

When using Claude Desktop with MCP servers, keep active tools to a minimum.
